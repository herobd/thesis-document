...
\begin{figure}
    ...
    \caption{This shows the QbS MAP for 18 n-grams on the Bentham dataset for varying sliding window sizes (in pixels).
    }
...
\end{subfigure}
\caption{Results for QbS subword spotting on the Bentham dataset. N-grams are arrange in descending order of frequency in test set. Trigrams are not displayed for space reasons.} %TODO add broken tri-gram results
